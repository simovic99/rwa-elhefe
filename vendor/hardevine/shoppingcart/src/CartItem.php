...
class CartItem implements Arrayable, Jsonable
{
     ...
     * @param array      $options
     */
    public function __construct($id, $name, $price,$img,array $options = [])
    {
        if(empty($id)) {
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price,$img ,array $options = [])
    {
        return new self($id, $name, $price,$img, $options);
    }
